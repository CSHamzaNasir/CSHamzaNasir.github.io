...
<!-- Mirrored from designarc.biz/demos/cake/theme/cake-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Apr 2024 10:07:04 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
        			...
        			<div class="row">
        				<div class="col-lg-6">
        					<div class="main_title">
								...
								<p>Explore our enticing selection of flavors, from classic favorites like rich chocolate and velvety vanilla to exotic creations bursting with tropical fruits and fragrant spices. Each cake is made with the finest ingredients, ensuring a taste that's as heavenly as it looks.</p>
							</div>
        					<div class="welcome_left_text">
        						<p>Conveniently located online, our cake shop is just a click away from bringing joy to your doorstep. Browse our website to explore our menu, place your order with ease, and prepare to embark on a culinary adventure like no other.</p>
        ...
        <!--================Special Recipe Area =================-->
		<?php include("components/special-cake-area.php"); ?>
        		...
        		<div class="row service_inner">
        			<div class="col-lg-4 col-6">
        				<div class="service_item">
        					...
        					<h4>Custom CupCakes</h4>
        					<p>A custom cake is a personalized dessert made to order, featuring unique flavors, designs, and decorations.</p>
        				</div>
        			</div>
        			<div class="col-lg-4 col-6">
        				<div class="service_item">
        					...
        					<p>A celebration cake is a special dessert made for important events, with unique decorations and flavors.</p>
        				</div>
        			</div>
        			<div class="col-lg-4 col-6">
        				<div class="service_item">
        					<i class="flaticon-food"></i>
        					<h4>Glitter CupCakes</h4>
        					<p>A glitter cupcake is a cupcake adorned with edible glitter, adding sparkle and flair to the dessert.</p>
        				</div>
        			</div>
        		</div>
        	</div>
       					...
       					<div class="col-lg-6">
       						<div class="discover_item_inner">
       							<div class="discover_item">
									...
									<p>Rich and indulgent, perfect for chocolate lovers. <span>$8.99</span></p>
								</div>
       							<div class="discover_item">
									<h4>Red Velvet Cake</h4>
									<p>A moist and velvety cake with a hint of cocoa and vibrant red color. <span>$9.99</span></p>
								</div>
       							<div class="discover_item">
									<h4>Carrot Cake</h4>
									<p>Moist and spiced cake filled with grated carrots and nuts, topped with cream cheese frosting.<span>$6.99</span></p>
								</div>
       							<div class="discover_item">
									<h4>Lemon Drizzle Cake</h4>
									<p>Light and tangy cake with a lemony flavor, topped with a sweet lemon glaze.<span>$7.99</span></p>
								</div>
       						</div>
       					</div>
       					<div class="col-lg-6">
       						<div class="discover_item_inner">
       							<div class="discover_item">
									<h4>Cheesecake</h4>
									<p>Creamy and decadent, with a smooth cream cheese filling on a graham cracker crust.<span>$8.99</span></p>
								</div>
       							<div class="discover_item">
									<h4>Angel Food Cake</h4>
									<p>Fluffy and airy cake made with whipped egg whites, perfect for a light dessert. <span>$7.99</span></p>
								</div>
       							<div class="discover_item">
									<h4>Strawberry Shortcake</h4>
									<p> Layers of sweet sponge cake, fresh strawberries, and whipped cream.<span>$10.99</span></p>
								</div>
       							<div class="discover_item">
									<h4>Black Forest Cake</h4>
									<p> Layers of chocolate sponge cake, whipped cream, and cherries, often soaked in kirsch liqueur.<span>$9.99</span></p>
								</div>
       						</div>
       					</div>
       				</div>
        		...
        		<div class="row our_chef_inner">
        			<div class="col-lg-3 col-6">
        				<div class="chef_text_item">
        					<div class="main_title">
								<h2>Our Chefs</h2>
								<p>Our cake chef is a professional baker or pastry chef who specializes in creating and decorating cakes. They have expertise in various cake-making techniques, flavor combinations, and decorative elements to craft visually stunning and delicious cakes for special occasions and events.</p>
							</div>
        				</div>
        			</div>
        			<div class="col-lg-3 col-6">
